...
const Interiit =  () => {
  ...
  async function getData (){
    const api = `http://localhost:1337/api/eventdata?page=interiit`;
  ...
  console.log(datamulti);
    return (
      <div>
        <Navbar name={data.data.attributes.Event_Name} slogan={data.data.attributes.EventSlogan}/>
